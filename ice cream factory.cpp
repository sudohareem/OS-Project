#include <stdio.h> //for basic input and output operations.
#include <stdlib.h> //for memory allocation
#include <unistd.h> //for fork, pipe, read, write
#include <pthread.h> //includes all the POSIX thread libraries
#include <semaphore.h> //for using semaphores, a synchronization tool to control access to common resources by multiple threads.
#include <string.h> //for string functions like strcpy and strcmp
#include <ctype.h> //for checking if a character is uppercase, numeric, etc.
#include <time.h> //time and date formats k liye
#include <sys/syscall.h> //to create our main system call
#include <linux/kernel.h> //or using kernel-related features
...
int main()
{
    ...
    int N;
    int choice;
    printf("*WELCOME TO HMZ ICE-CREAM PARLOUR*\n\n");
    do
    {
        choice = 0;
